...
<head>
  <meta charset="UTF-8">
  <title>HOTEL CASABLANCA ADMIN</title>
...
<body>
 ...
 <div class="container">
      ...
      <h1 style=" text-align: center;color: Black;font-size: 25px"> ADMIN LOGIN</h1> <br>
    ...
    <div class="bottom">  <h3><a href="../index.php">CASABLANCA HOMEPAGE</a></h3></div>
